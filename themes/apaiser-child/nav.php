                ...
                <div class="desktop-menu">
                    <div class="desktop">
                        ...
                        <ul class="menu">
                            ...
                            <li class="menu-item has-dropdown">
                                ...
                                <div class="dropdown">
                                    <div class="content">
                                        ...
                                        <div class="submenu_col">
                                            <h2 class="submenu-title"><a class="submenu-title-link" href="/journal">Journal</a></h2>                                       
                                        </div>                   
                                    </div>             
                                </div>
                            </li>
                            <li class="menu-item has-dropdown">
                                ...
                                <div class="dropdown">
                                    <div class="content">
                                        ...
                                        <div class="submenu_col">
                                            <h2 class="submenu-title"><a href="/collections">Collections</a></h2>
                            ...
                            <!-- <li class="menu-item"><a class="menu-link " href="/projects-commercial.html">Projects</a></li> -->
                        </ul>
